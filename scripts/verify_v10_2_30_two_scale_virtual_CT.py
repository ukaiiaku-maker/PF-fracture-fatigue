...
def main():
 ...
 refined=pd.read_csv(root/"A_NATIVE_refinement_validation.csv");require(len(refined)==3 and refined.admissible.all(),"anchor exceeds error gate without refinement");PT_validation=pd.read_csv(root/"PT_conditional_anchor_validation.csv");require(len(PT_validation)==20 and PT_validation.admissible.all(),"conditional PT interpolation unresolved")
