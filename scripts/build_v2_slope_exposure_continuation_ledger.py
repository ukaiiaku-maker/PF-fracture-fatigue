"""Build a portable, tracked event ledger for the one new exposure-
unconditioned completion trajectory -- same schema as the parent pilot's
and slope screen's ledgers.

Usage:
    <pinned interpreter> scripts/build_v2_slope_exposure_continuation_ledger.py \\
...
ARTIFACTS_DIR = REPO_ROOT / "artifacts/crack_rebonding_slope_exposure_continuation"
...
def main(argv: list[str] | None = None) -> int:
    ...
    completion_record: dict = json.loads((ARTIFACTS_DIR / "completion_record.json").read_text())
    ...
    ledger = {
        "schema": "v10.2.30_crack_rebonding_slope_exposure_continuation_event_ledger_v1",
        "classification": "EXPOSURE_UNCONDITIONED_COMPLETION",
        "parent_frozen_configuration_sha256": completion_record["parent_frozen_configuration_sha256"],
        "config_hash_reused": completion_record["config_hash_reused"],
