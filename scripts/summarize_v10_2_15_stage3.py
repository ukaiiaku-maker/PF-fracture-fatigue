#!/usr/bin/env python3
"""Aggregate Stage 3 case status for deterministic or signed-stochastic runs."""
...
def main() -> None:
    ...
    for path in sorted(root.glob("*/T*_th*/stage3_case_status.json")):
        ...
        selection_paths = (
            path.parent / "v10_2_17_parameter_selection.json",
            path.parent / "v10_2_15_parameter_selection.json",
        )
        selection = {}
