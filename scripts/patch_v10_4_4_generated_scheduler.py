#!/usr/bin/env python3
"""Patch a generated v10.2.30 scheduler for the v10.4.4 campaign."""
...
def transform(source: str) -> str:
    text = source.replace(OLD_ENTRY, MODEL_ENTRY)
    if text.count(MODEL_ENTRY) < 4:
        raise RuntimeError("v10.4.4 model-entry contract is incomplete")
