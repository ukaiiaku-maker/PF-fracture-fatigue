...
def main() -> int:
    ...
    parity=json.loads((root/"A_native_plus_8PT_true_accelerator_parity.json").read_text());require(parity["all_pass"] and parity["at_least_one_accepted_block"],"actual accelerator parity failed")
    require(parity["classification"]=="ACCELERATOR_PARITY_PASS","fallback-only parity admitted")
