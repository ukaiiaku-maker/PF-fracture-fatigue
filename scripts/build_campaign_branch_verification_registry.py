...
ROWS = [
    ...
    dict(branch="codex/v10.2.30-inverse-fatigue-barrier-design", commit="5034046963418254f39fc0116c30563bd17c1635",
         ...
         "-- requires --root; not completed",
         manuscript_link_found="RULED OUT (final-closure round 3) -- directly inspected every identif*/inverse*/"
         "recovery* file at this commit via `git show`: this is a prospective inverse-EXP-floor-barrier-fitting "
         "tool for declared crack-growth targets. It contains no 75-condition acquisition sequence, no four "
         "hidden-class (ceramic/weakT/peak/DBTT) synthetic-material design, and no 20-55%/1-10% recovery-error "
         "figures. The manuscript's Sec 4.5 synthetic-identifiability study is NOT sourced from this branch; "
         "the superficial name match was a false lead",
         disposition="RULED_OUT_NOT_THE_MANUSCRIPT_SOURCE", pushed="NO"),
]
