...
GENERATED_BASE=$(mktemp "$ROOT/scripts/.v10_2_30_gated_rate_orientation.XXXXXX")
GENERATED="${GENERATED_BASE}.sh"
mv "$GENERATED_BASE" "$GENERATED"
trap 'rm -f "$GENERATED"' EXIT

"$PYTHON_BIN" scripts/build_v10_2_30_rate_enabled_orientation_launcher.py \
  --source "$BASE" \
  --output "$GENERATED"
chmod +x "$GENERATED"
bash -n "$GENERATED"
...
printf 'Model entry: %s\n' \
  'arrhenius_fracture.sharp_front_v10_2_30_hazard_energy_gated_audited'
