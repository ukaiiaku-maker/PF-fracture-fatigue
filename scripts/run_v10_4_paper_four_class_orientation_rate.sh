...
printf 'Model revision: v10.4.3 stagger-consistent bulk plasticity\n'
...
printf 'Stagger semantics: fixed-point iterations over one dt; state re-based each iterate\n'
printf 'Accepted plastic work: converged final stagger only\n'
