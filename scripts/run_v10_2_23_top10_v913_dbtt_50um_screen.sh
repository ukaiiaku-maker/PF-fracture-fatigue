...
OUTROOT=${OUTROOT:-runs/v10_2_23_v913_top10_dbtt_50um_theta45_seed3621_v1}
FAMILY_JSON=${FAMILY_JSON:-$ROOT/runtime_inputs/v10_2_17/v10_2_14_active_only_campaign_family.json}
REGISTRY=${REGISTRY:-$ROOT/arrhenius_fracture/data/materials/v10_2_23_v913_top10_persistent_site_registry.csv}
ONE_D_REFERENCE=${ONE_D_REFERENCE:-$ROOT/arrhenius_fracture/data/materials/v10_2_23_v913_top10_1d_reference.csv}
OPTIONS=${OPTIONS:-"v913_top01_0091348_persistent_sites v913_top02_0086763_persistent_sites v913_top03_0115460_persistent_sites v913_top04_0097332_persistent_sites v913_top05_0127508_persistent_sites v913_top06_0116955_persistent_sites v913_top07_0060219_persistent_sites v913_top08_0242980_persistent_sites v913_top09_0103251_persistent_sites v913_top10_0080699_persistent_sites"}
...
for required in "$FAMILY_JSON" "$REGISTRY" "$ONE_D_REFERENCE"; do
...
from arrhenius_fracture.sharp_front_v10_2_23 import VALID_OPTIONS
...
if len(VALID_OPTIONS) != 10:
    raise SystemExit(f"expected 10 v10.2.23 options; got {len(VALID_OPTIONS)}")
print(f"V10223_PREFLIGHT project={arrhenius_fracture.PROJECT_ID} options={len(VALID_OPTIONS)} package={actual}")
PY
...
PY
  ...
  local cmd=(
    "$PYTHON_BIN" -u -m arrhenius_fracture.sharp_front_v10_2_23_audited
...
"$PYTHON_BIN" scripts/compare_v10_2_23_top10_1d_2d.py \
  ...
  --out-dir "$OUTROOT/comparison_1d_2d" || {
    echo "ERROR: 1-D/2-D comparison failed" >&2
    exit 1
  }

echo "v10.2.23 screen complete: complete=$complete_count failed=$failed_count output=$OUTROOT"
