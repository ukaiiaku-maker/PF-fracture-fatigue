...
OUTROOT=${OUTROOT:-runs/v10_2_26_paper_top2_100um_theta45_crn3621_v1}
...
payload = {
    "schema": "v10.2.26_paper_top2_long_rcurve_campaign_v1",
...
"$PYTHON_BIN" scripts/plot_v10_2_26_paper_top2_rcurves.py --outroot "$OUTROOT" || {
