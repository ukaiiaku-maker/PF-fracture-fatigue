...
def test_default_builder_runs_bounded_accepted_production_fixed_point():
    builder = (
    ...
    assert "run_v10_2_27_accepted_production_kernel_capture.sh" in builder
    ...
    assert "kernel_self_consistency_manifest.json" in builder
