...
def _configure(monkeypatch):
    ...
    monkeypatch.setenv("V10230_HIGH_CYCLE_MAX_MODE_OPERATIONS", "64")
...
def test_affine_dmd_propagates_linear_neutral_mode(monkeypatch):
...
def test_production_alias_reaches_1e12_through_dmd(monkeypatch):
    _configure(monkeypatch)
    ...
    monkeypatch.setattr(globals_dict["_transient"], "integrate_state_coupled_waveform", forbidden_subcycle)
    ...
    assert high.MODEL_ID.endswith("v3_affine_dmd")
