"""Audited v10.2.27 production physics with the v10.2.28 direct kernel provider."""
...
def main(argv=None):
    ...
    install_energy_ledger_output()
    original = _entry._base.PersistentSiteStateResolvedTipEngine
    _entry._base.PersistentSiteStateResolvedTipEngine = (
        AuditedPersistentSiteStateResolvedTipEngine
    )
    try:
        ...
        _entry._base.PersistentSiteStateResolvedTipEngine = original
