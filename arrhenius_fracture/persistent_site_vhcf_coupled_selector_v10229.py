"""VHCF nonlinear selector using the state-coupled waveform propagator."""
...
MODEL_ID = "v10.2.29_state_coupled_vhcf_selector_v1"
...
def _coupled_block_trial(
    ...
    trial = __import__("copy").deepcopy(engine)
...
def select_nonlinear_block(
    ...
    """Use the established nonlinear selector with coupled block trials."""
